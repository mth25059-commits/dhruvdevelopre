...
window.addEventListener('scroll', () => {
    ...
    scrollTimeout = setTimeout(() => {
        ...
        const tracks = document.querySelectorAll('.marquee-track');
        tracks.forEach(track => {
            track.style.animationDuration = ' Bhai ab main baki JS aur README complete kar deta hoon!

---

## 📄 **FILE 3 CONTINUED: `js/main.js`**
...
window.addEventListener('load', () => {
    ...
    if (heroTitle) {
        // Title already animates with CSS, but we can add scramble on hover
